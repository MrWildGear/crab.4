"""
Test file for EVELogReader.view_beacon_sessions method
Tests the beacon sessions viewing functionality
"""
import unittest
...
class TestViewBeaconSessions(unittest.TestCase):
    def setUp(self):
    ...
    def test_view_beacon_sessions_basic_functionality(self):
        """Test basic functionality of view_beacon_sessions"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.view_beacon_sessions()
            
    def test_view_beacon_sessions_handles_exception(self):
        """Test that view_beacon_sessions handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
