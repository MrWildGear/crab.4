"""
Test file for EVELogReader.monitoring_only_loop method
Tests the monitoring-only loop functionality
"""
import unittest
...
class TestMonitoringOnlyLoop(unittest.TestCase):
    def setUp(self):
    ...
    def test_monitoring_only_loop_basic_functionality(self):
        """Test basic functionality of monitoring_only_loop"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.monitoring_only_loop()
            
    def test_monitoring_only_loop_handles_exception(self):
        """Test that monitoring_only_loop handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
