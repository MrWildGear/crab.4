"""
Test file for EVELogReader.show_file_times method
Tests the file times display functionality
"""
import unittest
...
class TestShowFileTimes(unittest.TestCase):
    def setUp(self):
    ...
    def test_show_file_times_basic_functionality(self):
        """Test basic functionality of show_file_times"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.show_file_times()
            
    def test_show_file_times_handles_exception(self):
        """Test that show_file_times handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
