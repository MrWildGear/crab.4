"""
Test file for EVELogReader.toggle_high_frequency method
Tests the high frequency monitoring toggle functionality
"""
import unittest
...
class TestToggleHighFrequency(unittest.TestCase):
    def setUp(self):
    ...
    def test_toggle_high_frequency_basic_functionality(self):
        """Test basic functionality of toggle_high_frequency"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.toggle_high_frequency()
            
    def test_toggle_high_frequency_handles_exception(self):
        """Test that toggle_high_frequency handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
