"""
Test file for EVELogReader.show_version_info method
Tests the version information display functionality
"""
import unittest
...
class TestShowVersionInfo(unittest.TestCase):
    def setUp(self):
    ...
    def test_show_version_info_basic_functionality(self):
        """Test basic functionality of show_version_info"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.show_version_info()
            
    def test_show_version_info_handles_exception(self):
        """Test that show_version_info handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
