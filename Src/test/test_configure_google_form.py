"""
Test file for EVELogReader.configure_google_form method
Tests the Google Form configuration functionality
"""
import unittest
...
class TestConfigureGoogleForm(unittest.TestCase):
    def setUp(self):
    ...
    def test_configure_google_form_basic_functionality(self):
        """Test basic functionality of configure_google_form"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.configure_google_form()
            
    def test_configure_google_form_handles_exception(self):
        """Test that configure_google_form handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
