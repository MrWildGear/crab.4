"""
Test file for EVELogReader.clear_display method
Tests the display clearing functionality
"""
import unittest
...
class TestClearDisplay(unittest.TestCase):
    def setUp(self):
    ...
    def test_clear_display_basic_functionality(self):
        """Test basic functionality of clear_display"""
    ...
    def test_clear_display_handles_exception(self):
        """Test that clear_display handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
