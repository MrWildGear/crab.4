"""
Test file for EVELogReader.end_crab_failed method
Tests the CRAB session failure handling functionality
"""
import unittest
...
class TestEndCrabFailed(unittest.TestCase):
    def setUp(self):
    ...
    def test_end_crab_failed_basic_functionality(self):
        """Test basic functionality of end_crab_failed"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.end_crab_failed()
            
    def test_end_crab_failed_handles_exception(self):
        """Test that end_crab_failed handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
