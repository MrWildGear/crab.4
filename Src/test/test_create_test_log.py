"""
Test file for EVELogReader.create_test_log method
Tests the test log creation functionality
"""
import unittest
...
class TestCreateTestLog(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_test_log_basic_functionality(self):
        """Test basic functionality of create_test_log"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.create_test_log()
            
    def test_create_test_log_handles_exception(self):
        """Test that create_test_log handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
