"""
Test file for EVELogReader._stop_current_beacon_session method
Tests the current beacon session stop functionality
"""
import unittest
...
class TestStopCurrentBeaconSession(unittest.TestCase):
    def setUp(self):
    ...
    def test_stop_current_beacon_session_basic_functionality(self):
        """Test basic functionality of _stop_current_beacon_session"""
    ...
    def test_stop_current_beacon_session_handles_exception(self):
        """Test that _stop_current_beacon_session handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
