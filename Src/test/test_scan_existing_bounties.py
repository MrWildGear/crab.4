"""
Test file for EVELogReader.scan_existing_bounties method
Tests the existing bounty scanning functionality
"""
import unittest
...
class TestScanExistingBounties(unittest.TestCase):
    def setUp(self):
    ...
    def test_scan_existing_bounties_calls_display(self, mock_display):
        """Test that scan_existing_bounties calls display_combined_logs"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            # Verify display_combined_logs was called
            mock_display.assert_called_once()
            
    def test_scan_existing_bounties_handles_exception(self):
        """Test that scan_existing_bounties handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
