"""
Test file for EVELogReader.concord_countdown_loop method
Tests the CONCORD countdown loop functionality
"""
import unittest
...
class TestConcordCountdownLoop(unittest.TestCase):
    def setUp(self):
    ...
    def test_concord_countdown_loop_basic_functionality(self):
        """Test basic functionality of concord_countdown_loop"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.concord_countdown_loop()
            
    def test_concord_countdown_loop_handles_exception(self):
        """Test that concord_countdown_loop handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
