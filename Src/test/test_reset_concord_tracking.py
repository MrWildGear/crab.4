"""
Test file for EVELogReader.reset_concord_tracking method
Tests the CONCORD tracking reset functionality
"""
import unittest
...
class TestResetConcordTracking(unittest.TestCase):
    def setUp(self):
    ...
    def test_reset_concord_tracking_basic_functionality(self):
        """Test basic functionality of reset_concord_tracking"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.reset_concord_tracking()
            
    def test_reset_concord_tracking_handles_exception(self):
        """Test that reset_concord_tracking handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
