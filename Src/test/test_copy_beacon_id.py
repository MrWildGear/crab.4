"""
Test file for EVELogReader.copy_beacon_id method
Tests the beacon ID copying functionality
"""
import unittest
...
class TestCopyBeaconId(unittest.TestCase):
    def setUp(self):
    ...
    def test_copy_beacon_id_basic_functionality(self):
        """Test basic functionality of copy_beacon_id"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.copy_beacon_id()
            
    def test_copy_beacon_id_handles_exception(self):
        """Test that copy_beacon_id handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
