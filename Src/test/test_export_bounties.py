"""
Test file for EVELogReader.export_bounties method
Tests the bounty export functionality
"""
import unittest
...
class TestExportBounties(unittest.TestCase):
    def setUp(self):
    ...
    def test_export_bounties_basic_functionality(self):
        """Test basic functionality of export_bounties"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.export_bounties()
            
    def test_export_bounties_handles_exception(self):
        """Test that export_bounties handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
