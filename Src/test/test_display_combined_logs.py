"""
Test file for EVELogReader.display_combined_logs method
Tests the combined logs display functionality
"""
import unittest
...
class TestDisplayCombinedLogs(unittest.TestCase):
    def setUp(self):
    ...
    def test_display_combined_logs_basic_functionality(self):
        """Test basic functionality of display_combined_logs"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.display_combined_logs()
            
    def test_display_combined_logs_handles_exception(self):
        """Test that display_combined_logs handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
