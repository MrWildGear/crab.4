"""
Test file for EVELogReader.update_status_with_check_time method
Tests the status update with check time functionality
"""
import unittest
...
class TestUpdateStatusWithCheckTime(unittest.TestCase):
    def setUp(self):
    ...
    def test_update_status_with_check_time_basic_functionality(self):
        """Test basic functionality of update_status_with_check_time"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.update_status_with_check_time()
            
    def test_update_status_with_check_time_handles_exception(self):
        """Test that update_status_with_check_time handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
