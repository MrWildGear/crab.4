"""
Test file for EVELogReader.update_bounty_display method
Tests the bounty display update functionality
"""
import unittest
...
class TestUpdateBountyDisplay(unittest.TestCase):
    def setUp(self):
    ...
    def test_update_bounty_display_basic_functionality(self):
        """Test basic functionality of update_bounty_display"""
    ...
    def test_update_bounty_display_handles_exception(self):
        """Test that update_bounty_display handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
