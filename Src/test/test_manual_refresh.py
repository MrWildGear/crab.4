"""
Test file for EVELogReader.manual_refresh method
Tests the manual refresh functionality
"""
import unittest
...
class TestManualRefresh(unittest.TestCase):
    ...
    def test_manual_refresh_basic_functionality(self):
        """Test basic functionality of manual_refresh"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.manual_refresh()
            
    def test_manual_refresh_handles_exception(self):
        """Test that manual_refresh handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
