"""
Test file for EVELogReader.show_file_hashes method
Tests the file hashes display functionality
"""
import unittest
...
class TestShowFileHashes(unittest.TestCase):
    def setUp(self):
    ...
    def test_show_file_hashes_basic_functionality(self):
        """Test basic functionality of show_file_hashes"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.show_file_hashes()
            
    def test_show_file_hashes_handles_exception(self):
        """Test that show_file_hashes handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
