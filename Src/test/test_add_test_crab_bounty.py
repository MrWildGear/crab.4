"""
Test file for EVELogReader.add_test_crab_bounty method
Tests the test CRAB bounty addition functionality
"""
import unittest
...
class TestAddTestCrabBounty(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_test_crab_bounty_basic_functionality(self):
        """Test basic functionality of add_test_crab_bounty"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.add_test_crab_bounty()
            
    def test_add_test_crab_bounty_handles_exception(self):
        """Test that add_test_crab_bounty handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
