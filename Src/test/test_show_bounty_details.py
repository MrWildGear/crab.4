"""
Test file for EVELogReader.show_bounty_details method
Tests the bounty details display functionality
"""
import unittest
...
class TestShowBountyDetails(unittest.TestCase):
    def setUp(self):
    ...
    def test_show_bounty_details_basic_functionality(self):
        """Test basic functionality of show_bounty_details"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.show_bounty_details()
            
    def test_show_bounty_details_handles_exception(self):
        """Test that show_bounty_details handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
