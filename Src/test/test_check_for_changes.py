"""
Test file for EVELogReader.check_for_changes method
Tests the log file change detection functionality
"""
import unittest
...
class TestCheckForChanges(unittest.TestCase):
    ...
    def test_check_for_changes_basic_functionality(self):
        """Test basic functionality of check_for_changes"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.check_for_changes()
            
    def test_check_for_changes_handles_exception(self):
        """Test that check_for_changes handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
