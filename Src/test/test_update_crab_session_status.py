"""
Test file for EVELogReader.update_crab_session_status method
Tests the CRAB session status update functionality
"""
import unittest
...
class TestUpdateCrabSessionStatus(unittest.TestCase):
    def setUp(self):
    ...
    def test_update_crab_session_status_basic_functionality(self):
        """Test basic functionality of update_crab_session_status"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.update_crab_session_status()
            
    def test_update_crab_session_status_handles_exception(self):
        """Test that update_crab_session_status handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
