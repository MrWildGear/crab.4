"""
Test file for EVELogReader.perform_startup_crab_scan method
Tests the startup CRAB scan performance functionality
"""
import unittest
...
class TestPerformStartupCrabScan(unittest.TestCase):
    def setUp(self):
    ...
    def test_perform_startup_crab_scan_basic_functionality(self):
        """Test basic functionality of perform_startup_crab_scan"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
            ...
            reader.perform_startup_crab_scan()
            
    def test_perform_startup_crab_scan_handles_exception(self):
        """Test that perform_startup_crab_scan handles exceptions gracefully"""
        with patch('eve_log_reader.EVELogReader.find_eve_log_directory') as mock_find_dir, \
             patch('eve_log_reader.EVELogReader.setup_logging'), \
             patch('eve_log_reader.EVELogReader.setup_ui'), \
             patch('eve_log_reader.EVELogReader.load_log_files'), \
